...
<!-- Header (RTL) -->
<div
  class="container mx-auto px-4 sm:px-6 md:px-16 py-6 md:py-16 flex h-16 sm:h-24 items-center justify-between gap-6 md:gap-8"
  dir="rtl"
>
  <!-- Logo -->
  ...
  <!-- Desktop Nav -->
  <nav class="hidden md:flex items-center gap-4 sm:gap-6 font-medium" aria-label="التنقل الرئيسي">
    <a href="/" class="relative px-1 py-0.5 text-sm md:text-base transition-colors hover:text-primary
    ...
    <a href="/services.html" class="relative px-1 py-0.5 text-sm md:text-base transition-colors hover:text-primary
       after:content-[''] after:absolute after:left-1 after:right-1 after:-bottom-0.5 after:h-0.5 after:bg-primary
       after:scale-x-0 hover:after:scale-x-100 after:origin-right hover:after:origin-left after:transition-transform">خدمتنا</a>
    <a href="/pricing.html" class="relative px-1 py-0.5 text-sm md:text-base transition-colors hover:text-primary
       after:content-[''] after:absolute after:left-1 after:right-1 after:-bottom-0.5 after:h-0.5 after:bg-primary
       after:scale-x-0 hover:after:scale-x-100 after:origin-right hover:after:origin-left after:transition-transform">تسعير</a>
  </nav>

  <!-- CTA (desktop) -->
  <a id="ctaBtn" href="/contact.html"
     class="hidden md:inline-flex text-sm md:text-lg items-center justify-center rounded-3xl bg-primary text-secondary px-3 sm:px-10 py-3 shadow-sm hover:shadow-md transition-[box-shadow,transform]">
    احجز استشارتك الآن
      <div class="star-1">
    <svg
