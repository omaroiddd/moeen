    ...
    <div class="mx-auto w-full max-w-7xl p-4 py-6 lg:py-8">
      ...
      <div class="flex flex-col-reverse sm:flex-row gap-5 items-center sm:justify-between">
        <span class="text-sm text-gray-500 sm:text-center">
          © 2025 <a href="/en/" class="hover:underline">Moeen</a>. All rights reserved.
        </span>

        <div class="flex items-center gap-6">
<a href="#" class="lang-switch text-primary font-semibold hover:underline mt-4 sm:mt-0">العربية</a>


          <!-- Social icons -->
          <div class="flex mt-4 sm:justify-center sm:mt-0 gap-3">
            <a href="https://www.linkedin.com/company/moeen-%D9%85%D8%B9%D9%8A%D9%86" class="text-gray-500 hover:text-gray-900 social-icon">
            ...
            <a href="https://x.com/MoeenTalents" class="text-gray-500 hover:text-gray-900 social-icon">
